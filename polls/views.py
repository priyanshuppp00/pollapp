    ...
    if request.user.has_perm('polls.add_poll'):
        if request.method == 'POST':
            ...
            if form.is_valid:
                ...
                messages.success(
                    request, "Poll & Choices added successfully", extra_tags='alert alert-primary alert-dismissible fade show')
...
def add_choice(request, poll_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid:
            ...
            new_choice.save()
            messages.success(
                request, "Choice added successfully", extra_tags='alert alert-primary alert-dismissible fade show')
...
def choice_edit(request, choice_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid:
            ...
            new_choice.save()
            messages.success(
                request, "Choice Updated successfully", extra_tags='alert alert-primary alert-dismissible fade show')
            return redirect('polls:edit', poll.id)
    else:
...
def choice_delete(request, choice_id):
    ...
    choice.delete()
    messages.success(
        request, "Choice Deleted successfully", extra_tags='alert alert-primary alert-dismissible fade show')
    return redirect('polls:edit', poll.id)
